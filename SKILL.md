...
- Base 建模与写入：读 [`references/base-modeling.md`](references/base-modeling.md)，再按需读 `lark-base-*.md` 原子命令文档。
...
- 文档报告：读 [`references/report-template.md`](references/report-template.md)、[`references/lark-doc-create.md`](references/lark-doc-create.md)，需要追加或修订时读 [`references/lark-doc-update.md`](references/lark-doc-update.md)。
...
3. **设计分析过程仓库**
   - 创建新的飞书多维表格，命名建议：`数据分析过程记录仓库-<主题>-<日期>`。
   - 至少创建这些子表：
